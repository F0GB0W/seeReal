    ...
    <form action="insertSpoiler.bo" method="post" enctype="multipart/form-data">
      ...
      <table>
        ...
        <tbody>
          <tr>
            <th scope="row">제목</th>
            <td><input type="text" id="title" width="100px;" value="${b.boardTitle}" name="boardTitle" /></td>
          </tr>
          <tr>
            <th scope="row">작성자</th>
          ...
          <tr>
            <th scope="row">내용</th>
            <td><textarea id="content" rows="10" cols="100" style="resize:none;" name="boardContent" value="${b.boardContent }" ></textarea></td>
          </tr>
          <tr>
