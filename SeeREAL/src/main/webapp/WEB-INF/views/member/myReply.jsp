			        ...
			        <div id="pagingBar">
				        <ul id="pagination">
				      		...
				      		<c:choose>
				      			...
				      			<c:otherwise>
				      			<li class="page-item"><a class="page-link" href="myReply.me?cpage=${pi.currentPage - 1 }">Previous</a></li>
				      			</c:otherwise>
				      		</c:choose>
				      		
				      		<c:forEach begin="${pi.startPage }" end="${pi.endPage }" var="p" step="1">
				      			<li class="page-item"><a class="page-link" href="myReply.me?cpage=${p }">${p }</a></li>
				      		</c:forEach>
				      		...
				      		<c:choose>
				      			...
				      			<c:otherwise>
				      				<li class="page-item"><a class="page-link" href="myReply.me?cpage=${pi.currentPage + 1 }">Next</a></li>
				      			</c:otherwise>
				      		</c:choose>
				      	</ul>
			        </div>
